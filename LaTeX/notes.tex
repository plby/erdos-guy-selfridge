...
and
$$ L \coloneqq N^{0.1}.$$
We apply the algorithm from \Cref{alg-desc}, using the first option for Step 3.  With these parameters, we see from \Cref{baker} that the right-hand side of \eqref{new-balance-5} is at least
