...
\begin{itemize}
  ...
  \item If $p$ is a prime in ${\mathcal D}$, then all primes $p'<p$ smaller than $p$ also lie in ${\mathcal D}$.
\end{itemize}
...
If ${\mathcal D}$ is a downset and $d \in {\mathcal D}$, we define the density $\sigma_{d,{\mathcal D}}$ to be the product
