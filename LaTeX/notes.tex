...
\hline
(i) & $80<$ &$N$ & & \Cref{upper-crit} \\
(iv) (upper) & \multicolumn{3}{c|}{$N$ sufficiently large} & \Cref{upper-crit} \\
\hline
(ii) & $8\times 10^6 \leq$ & $N$ & & Rearrangement \\
(iii) & \multicolumn{3}{c|}{$N$ sufficiently large} & Rearrangement \\
(v) & $1.4\times 10^6 \leq$ & $N$ & & Rearrangement \\
\hline
(iii) & $10^{11} \leq $ & $N$ & & Modified approximate factorization \\
(iv) (lower) & \multicolumn{3}{c|}{$N$ sufficiently large} & Modified approximate factorization \\
  \hline
\end{tabular}
\medskip
