...
was shown for $x \geq e^{45} \approx 10^{19.54}$.  We may simply combine the latter two bounds to conclude that
$$ \psi(x) = x + O_{\leq}(\frac{\sqrt{x}}{8\pi} \log x(\log x - 3) + 1.11742 \times 10^{-8} x)$$
whenever $x \geq 10^{19}$.
