...
# Code to generate Figure 2 of the original paper, with updated values, covering the range 80 <= N <= 599
...
def plot2():
    ...
    plt.plot(base, lower, label='$t(N)/N$' )
    ...
    plt.plot(base, upper, linestyle=":", label='Lemma 5.1' )
